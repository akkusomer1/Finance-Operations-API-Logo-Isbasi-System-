...
namespace ZeusApp.Infrastructure.Migrations
{
    ...
    [Migration("20230725150255_addOrderTableAdressColumn")]
    partial class addOrderTableAdressColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OrderInvoiceType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.ProductOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.ProductService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ProductServiceCategoryId")
                        .HasColumnType("int");

                    b.Property<int>("ProductServiceType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.ProductServiceCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.ExpenseService", b =>
                {
                    ...
                    b.HasOne("ZeusApp.Domain.Entities.Catalog.ProductService", "ProductService")
                        .WithMany("ExpenseServices")
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.Invoice", b =>
                {
                    ...
                    b.HasOne("ZeusApp.Domain.Entities.Catalog.Order", "Order")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.Order", b =>
                {
                    b.HasOne("ZeusApp.Domain.Entities.Catalog.CarrierCompany", "CarrierCompany")
                        .WithMany()
                    ...
                    b.HasOne("ZeusApp.Domain.Entities.Catalog.OrderCategory", "OrderCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("ZeusApp.Domain.Entities.Catalog.ProductService", b =>
                {
                    ...
                    b.HasOne("ZeusApp.Domain.Entities.Catalog.ProductServiceCategory", "ProductServiceCategory")
